...
public class CleanEController {
    ...
    @FXML
    private TextField assignedUser, taskName, pointsValue, dueDay;
...
/* //  creates the link to scoreboard window
    ...
    private void appendTask() throws IOException {
        if ((assignedUser.getText() != "") && (taskName.getText() != "") && (Integer.parseInt(pointsValue.getText()) != 0) && (dueDay.getText() != "")){
    ...
    //clear textfields hverganger AddTask/Cancel button er brukt 
    @FXML
